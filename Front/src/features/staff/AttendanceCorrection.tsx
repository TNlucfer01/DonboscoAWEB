    ...
    return (
        <Layout user={user} onLogout={onLogout}>
            <div className="space-y-6">
                <h1 className="text-2xl text-foreground">Attendance Correction</h1>
                ...
                {fetched && students.length > 0 && (
                    <Card className="border-2 border-border">
                        ...
                        <CardContent>
                            {metadata && (
                                <div className="mb-6 grid grid-cols-2 md:grid-cols-4 gap-6 p-4 bg-muted/10 border border-border rounded-lg">
                                    <div>
                                        <p className="text-sm font-medium text-muted-foreground">Subject Name</p>
                                        <p className="mt-1 text-foreground font-semibold">{metadata.subjectName} ({metadata.subjectCode})</p>
                                    </div>
                                    <div>
                                        <p className="text-sm font-medium text-muted-foreground">Year</p>
                                        <p className="mt-1 text-foreground font-semibold">{metadata.year}</p>
                                    </div>
                                    <div>
                                        <p className="text-sm font-medium text-muted-foreground">Batch Name</p>
                                        <p className="mt-1 text-foreground font-semibold">{metadata.batchName}</p>
                                    </div>
                                    <div>
                                        <p className="text-sm font-medium text-muted-foreground">Submitted By</p>
                                        <p className="mt-1 text-foreground font-semibold">{metadata.submitterName}</p>
                                    </div>
                                </div>
                            )}
