...
const FontStyle = () => (
    <style>{`
        ...
        .dbcams-landing-panel.split { flex-basis: 42%; }
        ...
        .dbcams-hero-img {
            ...
            background-image: url('https://images.unsplash.com/photo-1625246333195-78d9c38ad449?auto=format&fit=crop&q=80&w=2000');
